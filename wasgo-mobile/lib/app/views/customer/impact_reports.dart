...
class ImpactReportsView extends StatelessWidget {
  const ImpactReportsView({super.key});
    ...
    return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Description
            const Text(
              'Track your environmental impact with detailed reports and analytics. See how your waste management choices are making a difference.',
              style: TextStyle(
                fontSize: 16,
