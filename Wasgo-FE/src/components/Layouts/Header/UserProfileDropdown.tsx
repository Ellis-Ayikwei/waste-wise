    ...
    return (
        <div className="dropdown shrink-0">
            <Dropdown
                ...
                closeOnTouch={true}
                button={
                    <div className="flex items-center gap-2 p-1.5 sm:p-2 rounded-xl bg-white/60 backdrop-blur-sm dark:bg-gray-800/60 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 touch-manipulation">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 flex items-center justify-center">
            ...
            >
                <div className="w-[280px] sm:w-[320px] md:w-[380px] max-w-[calc(100vw-2rem)] bg-white/95 backdrop-blur-xl border border-white/20 dark:bg-gray-800/95 dark:border-gray-700/50 rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/20 overflow-hidden">
                    {/* Profile Header */}
                    <div className="relative p-4 sm:p-6 bg-gradient-to-br from-green-500/10 via-green-400/10 to-green-300/10 dark:from-green-500/20 dark:via-green-400/20 dark:to-green-300/20 border-b border-gray-100 dark:border-gray-700">
                        <div className="flex items-center gap-3 sm:gap-4">
                            <div className="relative">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-lg">
                                    <IconUser className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                                </div>
                                <div className="absolute -bottom-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-green-500 border-2 border-white dark:border-gray-800 rounded-full flex items-center justify-center">
                    ...
                    <div className="p-2">
                            ...
                            <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors touch-manipulation">
                                ...
                                <div className="flex items-center gap-1">
                                    {themeConfig.theme === 'light' ? (
                                        <button
                                            className="p-2 rounded-lg bg-white shadow-sm hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 touch-manipulation min-h-[44px] min-w-[44px]"
                                        ...
                                        <button
                                            className="p-2 rounded-lg bg-gray-800 shadow-sm hover:bg-green-900/20 transition-all duration-300 touch-manipulation min-h-[44px] min-w-[44px]"
                                ...
                                <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors touch-manipulation">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                                            <IconExchange className="w-4 h-4 text-green-600 dark:text-green-400" />
                                        </div>
                                        <div>
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-green-100 dark:bg-green-900/30 hover:bg-green-200 dark:hover:bg-green-900/50 transition-colors touch-manipulation min-h-[44px]"
                                    >
                        ...
                        <div className="space-y-1">
                            ...
                            <Link
                                to={getDashboardPath()}
                                className="flex items-center gap-3 p-3 rounded-xl hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 group touch-manipulation min-h-[56px]"
                            >
                                <div className="w-8 h-8 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center group-hover:bg-green-200 dark:group-hover:bg-green-900/50 transition-colors">
                                    <IconMenuDashboard className="w-4 h-4 text-green-600 dark:text-green-400" />
                                </div>
                                <div className="flex-1">
                        ...
                        >
                            <div className="w-8 h-8 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                                {isLoggingOut ? (
                                    ...
                                    <IconLogout className="w-4 h-4 text-green-600 dark:text-green-400" />
                                )}
                            </div>
