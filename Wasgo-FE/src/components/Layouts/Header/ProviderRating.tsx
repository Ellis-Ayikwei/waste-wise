        ...
        <div className="hidden md:flex items-center gap-3 px-4 py-2 bg-white/60 backdrop-blur-sm border border-white/30 rounded-xl dark:bg-gray-800/60 dark:border-gray-600">
            <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center">
                    <FontAwesomeIcon icon={faRecycle} className="w-4 h-4 text-white" />
                </div>
                <div>
                        ...
                        <div className="flex items-center">
                            {[1, 2, 3, 4, 5].map((star) => (
                                <svg
                                    ...
                                    className={`w-3 h-3 ${star <= 4 ? 'text-green-500' : 'text-gray-300'}`}
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                >
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">1,247 collections</div>
                </div>
            </div>
            ...
            <div className="h-6 w-px bg-gray-300 dark:bg-gray-600"></div>
            <div className="flex items-center gap-1">
                <FontAwesomeIcon icon={faLeaf} className="w-3 h-3 text-green-500" />
                <span className="text-xs font-medium text-green-600 dark:text-green-400">Eco-friendly</span>
            </div>
        </div>
    );
};
