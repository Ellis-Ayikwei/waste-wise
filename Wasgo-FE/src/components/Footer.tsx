    ...
    <footer className="bg-gray-800 text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl text-white">wasgo</span>
            </Link>
            <p className="text-gray-400 mb-4">
              Ghana's leading The Waste Must Go platform. IoT-enabled bins, real-time tracking, and reliable collection services.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com/wasgo" className="text-gray-400 hover:text-green-500">
                <FaFacebook size={20} />
              </a>
              <a href="https://twitter.com/wasgo" className="text-gray-400 hover:text-green-500">
                <FaTwitter size={20} />
              </a>
              <a href="https://instagram.com/wasgo" className="text-gray-400 hover:text-green-500">
                <FaInstagram size={20} />
              </a>
              <a href="https://linkedin.com/company/wasgo" className="text-gray-400 hover:text-green-500">
                <FaLinkedin size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} wasgo Ghana. All rights reserved. | Cleaner Cities, Greener Future</p>
        </div>
      </div>
    </footer>
  );
