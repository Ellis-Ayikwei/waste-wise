...
import { resetForm, submitStepToAPI, updateFormValues } from '../../../../store/slices/createRequestSlice';
import showMessage from '../../../../helper/showMessage';
import { JourneyStop } from '../../../../types/booking';
        ...
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className="space-y-6 animate-fadeIn">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                    <div className="px-1 lg:px-6 py-4 bg-gray-50 dark:bg-gray-750 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <Field
                                    ...
                                    className="block w-full border border-gray-300 dark:border-gray-600 rounded-lg py-3 px-4 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white appearance-none bg-white dark:bg-gray-700"
                                />
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-750 border-b border-gray-200 dark:border-gray-700">
                                <h3 className="font-medium text-gray-800 dark:text-gray-200">Special Instructions</h3>
                            </div>
                            <div className="p-6">
                                <Field
                                    as="textarea"
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-750 border-b border-gray-200 dark:border-gray-700">
                                <h3 className="font-medium text-gray-800 dark:text-gray-200">Notes (Optional)</h3>
                            </div>
                            <div className="p-6">
                                <Field
                                    as="textarea"
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="rounded-md border border-gray-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white dark:bg-gray-700"
                            >
                                {[1, 2, 3, 4].map((count) => (
