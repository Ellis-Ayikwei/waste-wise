                ...
                <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-col items-end gap-2">
                            ...
                            >
                                {isWatching ? <Eye className="w-4 h-4" /> : <Bookmark className="w-4 h-4" />}
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div
                        className={`bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border ${
                            isWatching
                                ? 'border-blue-200 dark:border-blue-700/30'
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-lg p-3">
                                <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">{isWatching ? 'Watching since' : 'Saved on'}</p>
                                <p className="font-medium text-gray-700 dark:text-gray-300">{new Date(job.watch_created_at || job.save_created_at).toLocaleDateString('en-GB')}</p>
                            </div>
                        </div>
                        {isWatching && job.total_bids && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div className="bg-white dark:bg-gray-800 rounded-lg p-3">
                                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Current Bids</p>
                                    <p className="font-bold text-orange-600 dark:text-orange-400">{job.total_bids} bids</p>
                                </div>
                                {job.current_lowest_bid && (
                                    <div className="bg-white dark:bg-gray-800 rounded-lg p-3">
                                        <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Lowest Bid</p>
                            ...
                            {isWatching ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg flex items-center justify-center gap-2 transition-colors"
                                        title="Stop watching"
                                    >
                                ...
                                <>
                                    <button
                                        ...
                                        className="px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg flex items-center justify-center gap-2 transition-colors"
                ...
                <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex items-center justify-center min-h-screen">
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-12 border border-gray-200 dark:border-gray-700">
                            ...
                            <p className="text-gray-700 dark:text-gray-300 font-medium text-lg">Loading your watchlist...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Watching Jobs</h1>
                            <p className="mt-2 text-gray-600 dark:text-gray-400 text-lg">Keep track of interesting jobs and save them for later</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{jobs.watching?.length || 0}</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">Currently Watching</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{jobs.saved?.length || 0}</p>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{jobs.watching?.filter((job: any) => job.bidding_end_time).length || 0}</p>
