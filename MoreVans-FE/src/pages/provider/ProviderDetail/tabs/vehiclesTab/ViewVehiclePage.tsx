...
import { apiUrl, imgApiUrl } from '../../../../../services/axiosInstance';
...
const ViewVehiclePage: React.FC = () => {
    ...
    const handleDeleteVehicle = async () => {
        ...
        const isConfirmed = await confirmDialog({
            ...
            body: 'Are you sure you want to delete this vehicle? This action cannot be undone.',
            note: 'This action cannot be undone.',
            confirmText: 'Delete',
            cancelText: 'Cancel',
            finalQuestion: 'Are you sure you want to delete this vehicle? This action cannot be undone.',
        });
                ...
                {images.length > 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden mb-8">
                        ...
                        <div className="relative h-96 bg-gray-100 dark:bg-gray-700">
                            {images.length > 0 ? (
                                <img
                                    src={imgApiUrl+images[selectedImageIndex]?.image+"/"}
            ...
            {showImageModal && images.length > 0 && (
                ...
                >
                    ...
                    >
                        ...
                        <button
                            onClick={() => setShowImageModal(false)}
                            className="absolute top-2 right-2 md:top-4 md:right-4 bg-black bg-opacity-50 hover:bg-opacity-75 text-white rounded-full p-2 md:p-3 transition-all duration-200 z-20"
                        >
