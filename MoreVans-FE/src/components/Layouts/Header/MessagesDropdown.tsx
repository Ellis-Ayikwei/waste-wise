    ...
    return (
        <div className="dropdown shrink-0">
            <Dropdown
                ...
                btnClassName="relative block p-2 rounded-xl bg-white/60 backdrop-blur-sm dark:bg-gray-800/60 hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all duration-300 touch-manipulation"
                ...
                <ul className="!py-0 text-dark dark:text-white-dark w-[280px] sm:w-[350px] md:w-[400px] max-w-[calc(100vw-2rem)] text-xs bg-white/90 backdrop-blur-md border border-white/20 dark:bg-gray-800/90">
                    <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                        <div className="hover:!bg-transparent overflow-hidden relative rounded-t-md p-4 sm:p-5 text-white w-full !h-[60px] sm:!h-[68px]">
                            ...
                            <h4 className="font-semibold relative z-10 text-base sm:text-lg">Logistics Updates</h4>
                        </div>
                    </li>
                    {messages.length > 0 ? (
                        <>
                                    ...
                                    return (
                                        <div key={message.id} className="flex items-start gap-2 sm:gap-3 py-3 px-3 sm:px-5 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors touch-manipulation min-h-[64px]">
                                            ...
                                            <div className="flex-shrink-0 flex items-center gap-1 sm:gap-2">
                                                <span className="font-semibold bg-orange-100 text-orange-600 rounded-full text-xs px-2 py-1 whitespace-nowrap dark:bg-orange-900/30 dark:text-orange-400">
                                                    {message.time}
                                                </span>
                                                <button 
                                                    type="button" 
                            ...
                            <li className="border-t border-gray-200 dark:border-gray-600 text-center mt-5">
                                <button type="button" className="text-orange-500 font-semibold group hover:text-orange-600 justify-center !py-3 sm:!py-4 !h-[48px] sm:!h-[56px] transition-colors w-full touch-manipulation flex items-center text-xs sm:text-sm">
