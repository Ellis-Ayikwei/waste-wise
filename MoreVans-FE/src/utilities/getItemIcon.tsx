...
function isValidCategory(category: string): category is ItemCategory {
  const validCategories: ItemCategory[] = [
    'furniture', 'electronics', 'appliances', 'musical', 'boxes', 'fragile', 'exercise', 'garden',
    'office_supplies', 'kitchen_items', 'bathroom', 'seasonal', 'storage', 'children', 
    'art_hobbies', 'sports', 'oversized', 'tools_equipment', 'automotive', 'collectibles',
    'books_media', 'business_equipment', 'clothing_accessories', 'outdoor_recreation',
    'medical_equipment', 'home_decor'
  ];
