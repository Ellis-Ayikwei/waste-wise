...
const Invoices = () => {
    ...
    const cols = [
        ...
        { accessor: 'billed_user.full_name', title: 'To', sortable: true, hidden: hideCols.includes('billed_user.full_name') },
        {
            ...
            render: ({ total_amount }) => {
                const _tAm = total_amount as number;
                return Gbp(_tAm);
            },
        },
        {
            ...
            render: ({ total_paid }) => {
                const _tAp = total_paid as number;
                return Gbp(_tAp);
            },
        },
                        ...
                        <div className="grid md:grid-cols-2 sm:grid-cols-1 md:col-span-2 gap-3">
                            <div className="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                                ...
                                <div className="flex items-center mt-5">
                                    <div className="text-xl sm:text-sm md:text-xl lg:text-2xl xl:text-3xl font-bold ltr:mr-3 rtl:ml-3 flex items-center gap-2">{Gbp(totalPaidInvoices)}</div>
                                </div>
                            ...
                            <div className="panel bg-gradient-to-r from-amber-400 to-amber-500">
                                ...
                                <div className="flex items-center mt-5">
                                    <div className="text-xl sm:text-sm md:text-xl lg:text-2xl xl:text-3xl font-bold ltr:mr-3 rtl:ml-3 flex items-center gap-2">{Gbp(totalInvoices)}</div>
                                </div>
                                <div className="flex items-center font-semibold mt-5">for 5 groups</div>
                            </div>
                        </div>
