...
sensor_id = "0a2fb59c-a550-4378-806f-667b51c32393"
bin_id = "73c119c8-ed46-42cc-813b-67105fc8c765"
base_weight = 0.5  # Starting weight in kg
base_temperature = 25.0  # Starting temperature
id = "73c119c8-ed46-42cc-813b-67105fc8c765"
...
try:
    ...
    while True:  # Continue indefinitely
        ...
        for fill_level in range(1, 101):  # 1% to 100%
            ...
            battery_level = max(
                20, 100 - (fill_level * 0.5)
            )  # Battery decreases over time
            signal_strength = max(
                30, 100 - (fill_level * 0.2)
            )  # Signal decreases slightly
            ...
            # Print status
            status_emoji = (
                "🟢" if fill_level < 50 else "🟡" if fill_level < 80 else "🔴"
            )
            print(
        ...
        # After reaching 100%, wait a bit before starting the next cycle
        print("✅ Cycle completed! Starting next cycle in 5 seconds...")
        time.sleep(5)
